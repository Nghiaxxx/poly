...
export const colorMap: { [key: string]: string } = {
  ...
  '#E3E3E3': 'Titan trắng',
  '#232323': 'Titan đen',
  '#B9D9EB': 'Xanh dương pastel',
  '#F3E2A9': 'Vàng be',
  '#F5F5DC': 'Be',
  '#F8F8FF': 'Trắng xanh',
  '#F0FFF0': 'Xanh mint',
  '#F0F8FF': 'Xanh băng',
  '#E6E6FA': 'Tím lavender nhạt',
  '#FFFACD': 'Vàng chanh',
  '#FFE4E1': 'Hồng đào',
  '#F08080': 'Đỏ nhạt',
  '#DC143C': 'Đỏ',
  ...
  '#FFFF00': 'Vàng',
  '#FFFFE0': 'Vàng pastel',
  '#FAFAD2': 'Vàng kem sáng',
  '#EEE8AA': 'Vàng ngà',
  '#F0E68C': 'Vàng đất',
  '#BDB76B': 'Vàng ô liu',
  '#FFF0F5': 'Hồng lavender',
  '#D8BFD8': 'Tím pastel',
  '#DDA0DD': 'Tím hồng nhạt',
  '#EE82EE': 'Tím violet',
  '#DA70D6': 'Tím hồng',
  '#FFB6C1': 'Hồng nhạt',
  '#FFC0CB': 'Hồng',
  ...
  '#F0F2F2':'Khói trắng',
  '#F4E8CE':'Be nhạt',
  '#D6E4E5':'Xanh băng nhạt',
  '#747276':'Xám chì nhạt',
  '#E7E3DB': 'Trắng nhạt',
  '#E3DEE9': 'Tím pastel nhạt',
};
