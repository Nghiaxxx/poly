...
const SectionIpad: React.FC<SectionIpadProps> = ({
  products,
  getPriceRange,
  formatCurrency,
  getImageUrl,
  ...
  if (loading) return <div>Đang tải iPad...</div>;
  return (
    <section className="section bg-white">
      <div className="container mx-auto px-4 sm:px-6 md:px-10 lg:px-40">
        <div className="section-header flex justify-between items-center mb-6 bg-white">
          <h2 className="section-title text-2xl font-bold text-black">iPad</h2>
          <Link
              ...
              <SwiperSlide key={product._id}>
                <div className="relative">
                  ...
                  >
                    ...
                    {/* Product Image */}
                    <div className="relative flex items-center justify-center pt-5 bg-white">
                      <Image
                        src={getImageUrl(
                    ...
                    <div className="flex flex-col pl-4">
                      <h3 className="text-[14px] sm:text-[16px] lg:text-[18px] font-bold mb-1 sm:mb-3 text-black min-h-[1rem] sm:min-h-[1.5rem] mt-3" style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, 'SF Pro Display', sans-serif" }}>
                        {product.TenSP}
                        {product.variants &&
