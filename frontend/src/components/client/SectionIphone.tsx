...
const SectionIphone: React.FC<SectionIphoneProps> = ({
  products,
  getPriceRange,
  formatCurrency,
  getImageUrl,
  ...
  if (loading) return <div>Đang tải iPhone...</div>;
  return (
    <section className="section bg-white">
      <div className="container mx-auto px-4 sm:px-6 md:px-10 lg:px-40">
        <div className="section-header flex justify-between items-center mb-6 bg-white">
          <h2 className="section-title text-2xl font-bold text-black">iPhone</h2>
          <Link
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <div className="flex flex-col pl-4">
                      <h3 className="text-[14px] sm:text-[16px] lg:text-[18px] font-bold sm:mb-3 text-black min-h-[1rem] sm:min-h-[1.5rem] mt-5" style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, 'SF Pro Display', sans-serif" }}>
                        {product.TenSP}
                        {product.variants &&
