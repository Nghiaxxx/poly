...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        label: "Flash Sale",
        route: "/admin/flashsale",  // Sửa route
      },
      {
        icon: (
          <svg
          ...
          >
            <path
              d="M3.17 7.44L12 12.55L20.77 7.47M12 21.61L3.17 16.5V7.44M12 12.55V21.61M12 12.55L20.77 7.47V16.5L12 21.61"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
            ...
            />
            <path
              d="M12 3L20.77 7.47L12 12.55L3.17 7.44L12 3Z"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        label: "Sản phẩm",
        route: "/admin/product/products",  // Sửa route
      },
      {
        icon: (
          <svg
        ...
        label: "Đơn hàng",
        route: "/admin/order/orders",  // Sửa route
      },
      {
        icon: (
          <svg
          ...
          >
            <path
              d="M9 12l2 2 4-4M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.746 3.746 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 011.043-3.296 3.746 3.746 0 013.296-1.043A3.746 3.746 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.745 3.745 0 013.296 1.043 3.745 3.745 0 011.043 3.296A3.745 3.745 0 0121 12z"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
      ...
      },
      {
        ...
        label: "Danh mục",
        route: "/admin/category/categories",  // Sửa route
      },
      {
        icon: (
          <svg
        ...
        label: "Người dùng",
        route: "/admin/user/users",  // Sửa route
      },
      // {
      //   icon: (
      //     <svg
      ...
      //   ),
      //   label: "Gift Vouchers",
      //   route: "/admin/gift-vouchers",  // Sửa route
      // },
      {
        icon: (
          <svg
        ...
        label: "Voucher",
        route: "/admin/vouchers",  // Sửa route
      },
      {
        icon: (
          <svg className="fill-current" width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" stroke="currentColor" strokeWidth="1.5" fill="none"/></svg>
        ),
        label: "Đánh giá",
        route: "/admin/reviews",  // Sửa route
      },

      {
        ...
        label: "Tin tức",
        route: "/admin/new/news",  // Sửa route
      },
      {
        icon: (
          <svg
        ...
        label: "Settings",
        route: "/admin/settings",  // Sửa route
      },
    ],
  },
];
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`fixed left-0 top-0 z-50 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${
